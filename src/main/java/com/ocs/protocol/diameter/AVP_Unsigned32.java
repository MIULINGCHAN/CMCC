...
{
    public AVP_Unsigned32(final AVP avp) throws InvalidAVPLengthException {
        super(avp);
    ...
    public AVP_Unsigned32(final int n, final int n2) {
        super(n, int2byte(n2));
    }
    
    public AVP_Unsigned32(final int n, final int n2, final int n3) {
