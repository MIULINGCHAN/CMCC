...
public final class ProtocolConstants
{
	/**
	 * vendor-id定义：
	 * 当AVP值为IETF所定义，不需要vendor-ID
	 * 当AVP值为3GPP所定义，vendor-ID为10415
	 * 当AVP值为中国移动所定义，vendor-ID为28357
	 */
	public static final int VENDOR_ID_3GPP = 10415;
	public static final int VENDOR_ID_CMCC = 28357;
    ...
    public static final int _3GPP_CHARGING_ID = 2; //计费标识符
    ...
    public static final int _3GPP_DI_SUBSCRIBER_INFORMATION = 40102;
    public static final int _3GPP_DI_SUBSCRIBER_BELONG_AREA_NO = 40087;
