...
{
    public AVP_Unsigned64(final AVP avp) throws InvalidAVPLengthException {
        super(avp);
    ...
    public AVP_Unsigned64(final int n, final long n2) {
        super(n, long2byte(n2));
    }
    
    public AVP_Unsigned64(final int n, final int n2, final long n3) {
