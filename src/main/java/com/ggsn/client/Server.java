...
public class Server extends NodeManager {

	public Server(NodeSettings nodeSettings) {
		super(nodeSettings);
	}
...
//			port = 3868;
		...
		Server tss = new Server(node_settings);
		tss.start();
	...
	protected void handleRequest(Message request, ConnectionKey connkey,
		...
		// server
		System.out.println("ConnectionKey:" + connkey.hashCode());
